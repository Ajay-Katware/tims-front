...
export class SalesOrderComponent implements OnInit {
  ...
  displayedColumns = ['orderdate', 'salesorderno', 'reference', 'customername', 'status', 'amount', 'invoice', 'actions'];
  ...
  createInvoice(id:number){
    this.router.navigate(['/admin/salesorders/createinvoice'], { queryParams: { id: id } });
  }
